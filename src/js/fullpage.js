    ...
    function initialise(containerSelector, options) {
        ...
        */
        function addVerticalNavigation(){
            ...
            appendTo(navigation, container.closest("#content"));
        ...
        */
        function preventBouncing(e){
            if ((window.matchMedia(fpSettings.tabletMedia).matches && window.mainMenuOpened) || window.isFooterActive || window.matchMedia(fpSettings.mobileMedia).matches)
                return false
        ...
        */
        function touchMoveHandler(e){
            ...
            // if (window.matchMedia("screen and (max-width: 1300px)").matches && window.mainMenuOpened)
            //     return false
        ...
        */
        ...
        function MouseWheelHandler(e) {
            ...
            if (!isScrollAllowed.m.down && !isScrollAllowed.m.up) {
                ...
                if (!document.body.classList.contains("js__scroll-to-footer") 
                    && !window.selectizeOpen)
                    preventDefault(e);
                return false;
            }

            if ((window.matchMedia(fpSettings.tabletMedia).matches && window.mainMenuOpened) || window.matchMedia(fpSettings.mobileMedia).matches)
                return false
